...
class Robot {
	...
	String mkakeEggDishes(int flourNum, int sugarNum, int eggNum, int butterNum) {
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		String menu = robot.mkakeEggDishes(flourNum, sugarNum, eggNum, butterNum);
		if (menu != null) {
			System.out.println("\n" + menu + "が出来ました。");
		} else {
			System.out.println("\n何も作れません。");
